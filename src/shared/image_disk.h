...
class CImageDisk : public CImageBase
{
 ...
 public:
  ...
  virtual void set_bIsOpened(bool n)
    { m_bIsOpened = n; }
  virtual void set_szPath(const char * str)
    { strcpy(m_szPath, str); }
  virtual void set_szImageFilename(const char * str)
    { strcpy(m_szImageFilename,str); }
  virtual void set_szOriginalFilename(const char * str)
    { strcpy(m_szOriginalFilename,str); }
  virtual void set_szImageFilename(const char * str, int n)
    { printf("virtual szIF\n"); strncpy(m_szImageFilename,str, n); 
    printf("fin szIF\n");}
  virtual void set_szOriginalFilename(const char * str, int n)
