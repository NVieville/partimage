  ...
  if (!cFileRecord)
    {
      ...
      g_interface->msgBoxError(i18n("Out of memory: need %lu bytes to read file record"), m_info.dwFileRecordSize);
      THROW(ERR_ERRNO, errno);
    }	
...
// =======================================================
int CNtfsPart::readFilenameAttribute(BYTE *cAttribData, const char *szFilename)
{
  bool bAttribResident;
  char szTemp[4096];
  WORD nAttrSize;
...
// ================================================
int CNtfsPart::checkFilenameForRecordIs(BYTE *cRecordData, const char *szFilename, bool bShowDebug)
{
  BYTE *cData;
  WORD nOffsetSequenceAttribute;
  DWORD dwAttribType;
...
// ================================================
int CNtfsPart::searchForRecordFilename(BYTE *cFileRecord, const char *szFilename, char *szUnicodeName, int nUnicodeNameLen)
{
